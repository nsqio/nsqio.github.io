...
{% highlight bash %}
$ curl -d "<message>\n<message>\n<message>" http://127.0.0.1:4151/mpub?topic=test
{% endhighlight %}
...
{% highlight bash %}
$ curl -X POST http://127.0.0.1:4151/channel/create?topic=test&channel=ch
{% endhighlight %}
...
{% highlight bash %}
$ curl -X POST http://127.0.0.1:4151/channel/delete?topic=test&channel=ch
{% endhighlight %}
...
{% highlight bash %}
$ curl -X POST http://127.0.0.1:4151/topic/empty?topic=test
{% endhighlight %}
...
{% highlight bash %}
$ curl -X POST http://127.0.0.1:4151/channel/empty?topic=test&channel=ch
{% endhighlight %}
...
{% highlight bash %}
$ curl -X POST http://127.0.0.1:4151/channel/pause?topic=test&channel=ch
{% endhighlight %}
...
{% highlight bash %}
$ curl -X POST http://127.0.0.1:4151/channel/unpause?topic=test&channel=ch
{% endhighlight %}
...
Monitoring endpoint, should return `OK`. It returns an HTTP `500` if it is not healthy.

Method: **GET**

**NOTE**: The only "unhealthy" state would be if `nsqd` failed to write messages to disk when
overflow occurred.
