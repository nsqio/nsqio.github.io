...
The `nsqd` instance will push to the following `statsd` paths:
    ...
    nsq.<nsqd_host>_<nsqd_port>.topic.<topic_name>.channel.<channel_name>.client.finished_count
    nsq.<nsqd_host>_<nsqd_port>.topic.<topic_name>.channel.<channel_name>.client.requeue_count
