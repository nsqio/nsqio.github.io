 ...
 * [`/config/nsqlookupd_tcp_addresses`](#get-config) - returns array of nsqlookupd  addresses
 * [`/config/nsqlookupd_tcp_addresses`](#put-config) - updates nsqlookupd TCP addresses
...
* #### `PUT` `/config/nsqlookupd_tcp_addresses`
  ...
  Example:
      ...
      $ curl -X PUT -d '["127.0.0.1:4160", "127.0.0.2:4160"]' http://127.0.0.1:4151/config/nsqlookupd_tcp_addresses
